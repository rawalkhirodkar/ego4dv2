...
# SEQUENCE='013_tagging'; DEVICES=0, 
...
# SEQUENCE='004_fencing2'; DEVICES=0, 
# SEQUENCE='005_fencing2'; DEVICES=0,
# SEQUENCE='006_fencing2'; DEVICES=0, 
# SEQUENCE='007_fencing2'; DEVICES=1, 
# SEQUENCE='008_fencing2'; DEVICES=0,
# SEQUENCE='009_fencing2'; DEVICES=1, 
