...
###----------------------------------------------------------------
RUN_FILE='tools/benchmark/coco_format.py'
...
# SEQUENCE='001_badminton'; DEVICES=0,

###-----------------------------------------------------------------
OUTPUT_DIR="/media/rawalk/disk1/rawalk/datasets/ego_exo/benchmark/${BIG_SEQUENCE}/$SEQUENCE"
