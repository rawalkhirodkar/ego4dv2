...
def coco_add_to(sequence_name, parent_sequence_name, COCO_OUTPUT, poses2d, image_path, image_width, image_height, camera_name, camera_mode, time_stamp):
    ...
    for t in tqdm(time_stamps):
        ...
        for (camera_name, camera_mode) in cameras:
            ...
            if camera_name.startswith('cam'):
                coco_add_to(sequence_name, parent_sequence, COCO_EXO_OUTPUT, poses2d, image_path, image_width, image_height, camera_name, camera_mode, t)

            elif camera_name.startswith('aria'):
                if camera_mode == 'rgb':
                    coco_add_to(sequence_name, parent_sequence, COCO_EGO_RGB_OUTPUT, poses2d, image_path, image_width, image_height, camera_name, camera_mode, t)

                else:
                    coco_add_to(sequence_name, parent_sequence, COCO_EGO_SLAM_OUTPUT, poses2d, image_path, image_width, image_height, camera_name, camera_mode, t)
