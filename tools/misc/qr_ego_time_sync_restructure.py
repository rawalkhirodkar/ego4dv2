...
def main():
  ...
  overall_start_qr_timestamps_ = [int(timestamp.split(':')[1]) for timestamp in args.qr_timestamps.split('--')] ## this corresponds to 00001.jpg in exo

  overall_start_timestamps = {}
  overall_start_qr_timestamps = {}

  for idx, timestamp in enumerate(overall_start_timestamps_):
    overall_start_timestamps[cameras[idx]] = timestamp
  
  for idx, qr_timestamp in enumerate(overall_start_qr_timestamps_):
    overall_start_qr_timestamps[cameras[idx]] = qr_timestamp
